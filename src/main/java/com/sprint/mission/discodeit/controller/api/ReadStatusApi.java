...
public interface ReadStatusApi {
  ...
  @ApiResponses(value = {
      @ApiResponse(responseCode = "201", description = "메시지 읽음 상태 정보 생성 성공", content = @Content(schema = @Schema(implementation = ReadStatusDto.class))),
  ...
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "메시지 읽음 상태 정보 수정 성공", content = @Content(schema = @Schema(implementation = ReadStatusDto.class))),
  ...
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "메시지 읽음 상태 목록 조회 성공", content = @Content(array = @ArraySchema(schema = @Schema(implementation = ReadStatusDto.class))))
  })
